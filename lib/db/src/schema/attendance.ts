...
export const attendanceTable = pgTable("attendance", {
  ...
  timeOutLatitude: doublePrecision("time_out_latitude"),
  timeOutLongitude: doublePrecision("time_out_longitude"),
  timeOutLocationAddress: text("time_out_location_address"),
